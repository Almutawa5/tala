...
export const translations: Record<string, Record<string, string>> = {
    en: {
        ...
        grams: "Grams",
        ounces: "oz (Troy)",
        toggleUnit: "Toggle weight unit",
        validationNegative: "Value cannot be negative",
    ...
    ar: {
        ...
        // New translations
        compareShops: "مقارنة المحلات",
        addShop: "إضافة محل",
        bestDeal: "أفضل سعر!",
        grams: "جرام",
        ounces: "أونصة",
        toggleUnit: "تغيير وحدة الوزن",
        validationNegative: "القيمة لا يمكن أن تكون سالبة",
        validationMax: "القيمة القصوى هي",
        loading: "جاري التحميل...",
        shareViaWhatsApp: "مشاركة عبر واتساب",
        shareCalculation: "مشاركة الحساب",
